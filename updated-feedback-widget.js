(function () {
  ...
  console.log('🚀 Updated Feedback Widget: Script loaded');
  ...
  const UI = {
    styles(c) {
      ...
      DOM.style(`
        ...
        .nx-modal {
          ...
          width:320px; background:${c.backgroundColor};
        ...
        .nx-modal input, .nx-modal textarea {
        ...
        .nx-modal input:focus, .nx-modal textarea:focus {
          outline: none;
        ...
        .nx-error {
          color: #dc2626; font-size: 12px; margin-top: 8px;
    ...
    render(c) {
      ...
      // Button
      const btn = DOM.el('button', 'nx-btn', '💬');
      ...
      modal.innerHTML = `
        ...
        ${c.showNameField ? `
          <div class="nx-field-group">
            <label class="nx-field-label">
              Your name ${c.requireName ? '<span class="nx-required">*</span>' : '(optional)'}
            </label>
            <input type="text" placeholder="Your name" class="nx-name">
          </div>
        ` : ''}
        ${c.showEmailField ? `
          <div class="nx-field-group">
            <label class="nx-field-label">
              Your email ${c.requireEmail ? '<span class="nx-required">*</span>' : '(optional)'}
            </label>
            <input type="email" placeholder="your@email.com" class="nx-email">
          </div>
        ` : ''}
        <div class="nx-field-group">
          <label class="nx-field-label">
            Your feedback <span class="nx-required">*</span>
          </label>
      ...
      submitBtn.addEventListener('click', async () => {
        const name = c.showNameField && nameInput ? nameInput.value.trim() : null;
        ...
        if (c.requireName && (!name || name.length < 2)) {
        ...
        try {
          ...
          if (nameInput) DOM.hide(nameInput);
          if (emailInput) DOM.hide(emailInput);
          DOM.hide(submitBtn);
