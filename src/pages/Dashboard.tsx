    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between" data-tour="dashboard-welcome">
                <div>
                    <h1 className="text-3xl font-bold text-primary dark:text-primary-foreground ">Analytics Dashboard</h1>
                    <p className="text-primary dark:text-primary-foreground mt-2">
