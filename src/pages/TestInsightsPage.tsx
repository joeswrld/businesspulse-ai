...
const TestInsightsPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">AI Analytics Test Page</h1>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-green-600 font-medium">
            ✅ The AI Analytics page is loading correctly!
          </p>
...
export default TestInsightsPage;