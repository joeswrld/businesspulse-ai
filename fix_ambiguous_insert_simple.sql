-- Simple fix for ambiguous column references in INSERT
-- This uses a different approach to avoid the ambiguity issue

-- Drop and recreate the refresh_user_usage function
DROP FUNCTION IF EXISTS refresh_user_usage(UUID, DATE) CASCADE;

-- Create refresh_user_usage function without ambiguous references
...
SELECT '🎉 Ambiguous INSERT References Fixed with Simple Approach!' as summary;