...
{
  "executive_summary": "2-3 sentences summarizing the key findings from the insights",
  "key_insights": ["extract 3-5 key points directly from the insights_data"],
  "trends": ["identify 2-3 patterns or trends from the insights_data"],
  "recommended_actions": ["suggest 3-4 actionable steps based on the insights_data"],
