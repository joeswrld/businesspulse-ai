...
-- Create team_activities table for real-time collaboration
...
-- Create a scheduled job to clean expired invitations (runs daily)
-- Note: This requires pg_cron extension which may not be available in all Supabase instances
-- SELECT cron.schedule('clean-expired-invitations', '0 0 * * *', 'SELECT clean_expired_invitations();');