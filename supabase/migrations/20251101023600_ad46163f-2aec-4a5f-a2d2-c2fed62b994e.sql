-- Fix Security DEFINER Functions - Add search_path Protection
-- This prevents search_path hijacking attacks on privileged functions

-- 1. Update get_public_widget_settings
...
-- 2. Update get_or_create_user_project
...
-- 3. Update get_user_profile_with_access
...
-- 5. Update initialize_user_trial
...
-- 6. Update upgrade_user_to_business
...
-- 9. Update create_feedback_settings_for_user
