...
-- ===============================
-- 1. Update user profiles table for trial tracking
-- ===============================

-- Add trial tracking columns to user profiles if they don't exist
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS trial_start TIMESTAMPTZ;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS trial_end TIMESTAMPTZ;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS plan VARCHAR(20) DEFAULT 'free_trial';
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT FALSE;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS trial_expired BOOLEAN DEFAULT FALSE;
