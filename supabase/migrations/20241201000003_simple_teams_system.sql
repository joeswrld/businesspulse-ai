-- Simple Teams System Migration
-- This migration creates the teams system step by step
...
-- Step 3: Create team_members table with foreign key
...
-- Step 4: Create team_invitations table with foreign key
...
-- Step 5: Create team_activities table with foreign key
...
-- Step 8: Create RLS policies for teams
...
-- Step 10: Create RLS policies for team_invitations
...
-- Step 11: Create RLS policies for team_activities
