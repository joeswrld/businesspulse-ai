-- Fix team_invitations table - Add missing columns
-- This migration adds the missing columns that are referenced in the invitation system
...
-- Make inviter_id NOT NULL after setting default values
ALTER TABLE team_invitations 
...
-- Update the role column to include all possible values
ALTER TABLE team_invitations 
