-- Migration to ensure feedback system is available for all users
-- This migration creates the necessary functions and ensures tables exist

-- Create the comprehensive setup function
...
-- Ensure all existing users have feedback settings
DO $$
DECLARE
    user_record RECORD;
BEGIN
    FOR user_record IN SELECT id FROM auth.users LOOP
        PERFORM ensure_user_feedback_settings(user_record.id);
    END LOOP;
END $$;